PROGRAM tabulation_example
    ...
    CALL InitDglapHolder(grid, dh, factscheme = factscheme_MSbar, nloop = nloop, nflo = 3, nfhi = 6)
    ...
    CALL EvalPdfTable_xQ(table, heralhc_xvals, Q, pdf_at_xQ)
...
CONTAINS
    ...
    FUNCTION unpolarized_dummy_pdf(xvals) RESULT(pdf)
        ...
        ! parameters.txt is created automatically from the R code
